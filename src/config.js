...
module.exports = Object.assign({
  ...
  app: {
    ...
    description: 'Github Pages using React to split Frontend and Backend.',
    head: {
      titleTemplate: 'Alexoner\'s homepage: %s',
      meta: [
        {name: 'description', content: 'Github Pages using React to separate Front-end and Back-end.'},
        {charset: 'utf-8'},
